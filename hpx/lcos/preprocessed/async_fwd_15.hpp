...
namespace hpx
{
    ...
    lcos::future<
        typename traits::promise_local_result<
            typename hpx::actions::action<F, funcptr>::result_type
        >::type
    >
    async (hpx::actions::action<F, funcptr> , naming::id_type const& gid);
}
namespace hpx
{
    ...
    >
    async (
        hpx::actions::action<F, funcptr> , naming::id_type const& gid,
